...
//interface
import { IUniswapV3Pool } from "../external/uniswap/v3-core/interfaces/IUniswapV3Pool.sol";
...
import { OracleLibrary } from "../external/opyn/OracleLibrary.sol";

/**
 * @title UniswapTwapLibrary
 * @notice calculate the price of base asset in terms of quote asset, always assuming 18 decimals for quote asset
 * @author Opyn team (originally Squeeth "Oracle" contract), put into Library form by Duality
 * @dev original: https://github.com/opynfinance/squeeth-monorepo/blob/main/packages/hardhat/contracts/core/Oracle.sol
 */
library UniswapTwapLibrary {
     ...
     */
    function getMaxPeriod(address _pool) internal view returns (uint32) {
